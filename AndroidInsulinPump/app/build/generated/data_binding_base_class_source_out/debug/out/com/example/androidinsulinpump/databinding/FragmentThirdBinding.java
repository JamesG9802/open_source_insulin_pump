...
public final class FragmentThirdBinding implements ViewBinding {
  ...
  private FragmentThirdBinding(@NonNull ConstraintLayout rootView, @NonNull Button buttonSecond) {
  ...
  public static FragmentThirdBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentThirdBinding((ConstraintLayout) rootView, buttonSecond);
    }
