...
*/
    public void onBtnClick(View view)   {
        ...
        EditText edtTxtName = findViewById(R.id.cgmInput);
        TextView txtHello = findViewById(R.id.txtMessage);

        txtHello.setText("shut up");
        Toast.makeText(this, "Sent CGM Data: " + edtTxtName.getText().toString(), Toast.LENGTH_SHORT).show();
    }

    public void toMealData(View view)   {
        setContentView(R.layout.activity_meal_data);

    }

    public void toProfileData(View view)    {
